...
def admin_page():
    ...
    #Counts
    def adm_draw_count():
        cnt1 = Entry(admin_window, width=15)
        cnt1.grid(row=2, column=6) #지금은 이거인데 아마 버튼 넣으면서 칼럼 픽셀 줄이면 8로하는게 맞지안을까
        cnt1.insert(END, m.items_count[0])
        cnt2 = Entry(admin_window, width=15)
        cnt2.grid(row=3, column=8)
        cnt2.insert(END, m.items_count[1])
        cnt3 = Entry(admin_window, width=15)
        cnt3.grid(row=4, column=8)
        cnt3.insert(END, m.items_count[2])
        cnt4 = Entry(admin_window, width=15)
        cnt4.grid(row=5, column=8)
        cnt4.insert(END, m.items_count[3])
        cnt5 = Entry(admin_window, width=15)
        cnt5.grid(row=6, column=8)
        cnt5.insert(END, m.items_count[4])
        cnt6 = Entry(admin_window, width=15)
        cnt6.grid(row=7, column=8)
        cnt6.insert(END, m.items_count[5])
        cnt7 = Entry(admin_window, width=15)
        cnt7.grid(row=8, column=8)
        cnt7.insert(END, m.items_count[6])
        cnt8 = Entry(admin_window, width=15)
        cnt8.grid(row=9, column=8)
        cnt8.insert(END, m.items_count[7])
        cnt9 = Entry(admin_window, width=15)
        cnt9.grid(row=10, column=8)
        cnt9.insert(END, m.items_count[8])
        cnt10 = Entry(admin_window, width=15)
        cnt10.grid(row=11, column=8)
        cnt10.insert(END, m.items_count[9])
        cnt11 = Entry(admin_window, width=15)
        cnt11.grid(row=12, column=8)
        cnt11.insert(END, m.items_count[10])
        cnt12 = Entry(admin_window, width=15)
        cnt12.grid(row=13, column=8)
        cnt12.insert(END, m.items_count[11])
        cnt13 = Entry(admin_window, width=15)
        cnt13.grid(row=14, column=8)
        cnt13.insert(END, m.items_count[12])
        cnt14 = Entry(admin_window, width=15)
        cnt14.grid(row=15, column=8)
        cnt14.insert(END, m.items_count[13])
        cnt15 = Entry(admin_window, width=15)
        cnt15.grid(row=16, column=8)
        cnt15.insert(END, m.items_count[14])
        cnt16 = Entry(admin_window, width=15)
        cnt16.grid(row=17, column=8)
        cnt16.insert(END, m.items_count[15])
        cnt17 = Entry(admin_window, width=15)
        cnt17.grid(row=18, column=8)
        cnt17.insert(END, m.items_count[16])
        cnt18 = Entry(admin_window, width=15)
        cnt18.grid(row=19, column=8)
        cnt18.insert(END, m.items_count[17])
        cnt19 = Entry(admin_window, width=15)
        cnt19.grid(row=20, column=8)
        cnt19.insert(END, m.items_count[18])
        cnt20 = Entry(admin_window, width=15)
        cnt20.grid(row=21, column=8)
        cnt20.insert(END, m.items_count[19])
        cnt21 = Entry(admin_window, width=15)
        cnt21.grid(row=22, column=8)
        cnt21.insert(END, m.items_count[20])
        cnt22 = Entry(admin_window, width=15)
        cnt22.grid(row=23, column=8)
        cnt22.insert(END, m.items_count[21])
        cnt23 = Entry(admin_window, width=15)
        cnt23.grid(row=24, column=8)
        cnt23.insert(END, m.items_count[22])
        cnt24 = Entry(admin_window, width=15)
        cnt24.grid(row=25, column=8)
        cnt24.insert(END, m.items_count[23])
        cnt25 = Entry(admin_window, width=15)
        cnt25.grid(row=26, column=8)
        cnt25.insert(END, m.items_count[24])
        cnt26 = Entry(admin_window, width=15)
        cnt26.grid(row=27, column=8)
        cnt26.insert(END, m.items_count[25])
        cnt27 = Entry(admin_window, width=15)
        cnt27.grid(row=28, column=8)
        cnt27.insert(END, m.items_count[26])
        cnt28 = Entry(admin_window, width=15)
        cnt28.grid(row=29, column=8)
        cnt28.insert(END, m.items_count[27])
        cnt29 = Entry(admin_window, width=15)
        cnt29.grid(row=30, column=8)
        cnt29.insert(END, m.items_count[28])
        cnt30 = Entry(admin_window, width=15)
        cnt30.grid(row=31, column=8)
        cnt30.insert(END, m.items_count[29])
    adm_draw_count()
####################### 결제 방식 변경
